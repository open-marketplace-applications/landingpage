<template>
  <div class="hero">
    <img class="bg-image" src="@/assets/hero_image.jpg">
    <div class="layer"></div>
    <div class="hello">
      ...
      <div class="animated-heading">
        <div class="animated-heading__container">
          <ul class="animated-heading__container__list">
            ...
            <li class="animated-heading__container__list__item">Dezentralized</li>
            <li class="animated-heading__container__list__item">Non-profit</li>
          </ul>
        </div>
      </div>
    </div>
